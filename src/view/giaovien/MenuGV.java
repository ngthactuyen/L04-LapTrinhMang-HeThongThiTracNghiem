...
public class MenuGV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_thongtincanhan.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btn_dangxuat, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_thongtincanhan, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_thongtincanhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_thongtincanhanActionPerformed
        // TODO add your handling code here:
        //this.setVisible(false);
        ThongTinGV thongtinGV = new ThongTinGV();
        thongtinGV.setVisible(true);
        thongtinGV.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            qlsv.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(MenuGV.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            qlmh.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(MenuGV.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(MenuGV.class.getName()).log(Level.SEVERE, null, ex);
